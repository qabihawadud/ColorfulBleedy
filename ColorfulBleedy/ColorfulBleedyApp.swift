...
@main
struct ColorfulBleedyApp: App {
    @StateObject private var gameManager = GameData()
...
class ServerResponseHandler: ObservableObject {
    ...
    private var serverURL: String {
        if let url = Bundle.main.object(forInfoDictionaryKey: "ServerBaseURL") as? String {
            return url + "/ios-colorful-bleedy/server.php"
        }
        return "https://gtappinfo.site/ios-colorful-bleedy/server.php"
    }
...
struct LoadingView: View {
    ...
    @EnvironmentObject var gameManager: GameData // Add this
